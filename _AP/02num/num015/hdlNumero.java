public class hdlNumero {
    ...
    public static void MostrarSumarDigitosPrimos (){
        int sdp = objNum.SumarDigitosPrimos();
        System.out.print("La suma de los dígitos Primos es: " + sdp);
    }

    public static void VerificarSiEsBinario (){
        boolean respuesta = objNum.Binario();

        if(respuesta){
            System.out.print("El numero " + objNum.getNumero() + " es Binario");
        }else{
            System.out.print("El numero " + objNum.getNumero() + " NO es Binario");
        }
    }
