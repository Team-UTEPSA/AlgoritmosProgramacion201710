class Main {
    ...
    public static void mostrar_menu (){
        ...
        System.out.print("\t[J] Sumar los dígitos primos\n");
        System.out.print("\t[K] Es binario?\n");
    ...
    public static void elegir_opcion (){
        ...
        switch(cOpcion){
            case 'A':
                ...
                {
                     //error handling code
                     System.out.print("El número está fuera de rango [0;2147483647]\n");
                     System.out.print(e);
                }
            ...
            case 'H':
                ...
                break;
            case 'I':
                byte yPos = get_byte("Introduzca la posición a consultar: ");
                objNumero.MostrarDigitoPosicion(yPos);
                break;
            case 'J':
                objNumero.MostrarSumarDigitosPrimos();
                break;
            case 'K':
                objNumero.VerificarSiEsBinario();
                break;
